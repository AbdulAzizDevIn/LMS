...
const SearchResult = ({ course,key }) => {
  return (
    <div key={key} className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-300 py-4 gap-4">
      <Link
      ...
      <div className=" mt-4 md:mt-0 md:text-right w-full md:w-auto ">
        <h1 className="flex items-center font-bold text-lg md:text-xl">
           <IndianRupee size={18}/>{course?.coursePrice}
        </h1>
      </div>
    </div>
  );
