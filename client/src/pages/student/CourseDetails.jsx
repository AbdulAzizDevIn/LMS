...
const CourseDetails = () => {
  ...
  if (isError) return <h1 className="flex justify-center items-center h-screen font-bold">Failed to load course details</h1>;
        ...
        <div className="w-full lg:w-1/3">
          <Card>
            ...
            <CardFooter className="flex justify-center p-4">
              {purchased ? (
                <Button className="w-full" onClick={handelContinueCourse}>
                  Continue Course
                </Button>
              ) : (
